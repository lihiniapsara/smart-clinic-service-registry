...
The Service-Registry acts as the central directory for the microservices architecture. When a service starts, it registers with this server. The API Gateway queries this registry to resolve service locations using load-balanced URIs (e.g., `lb://PATIENT-SERVICE`).
...
Public Eureka dashboard URL (for final submission): `https://eureka.smartclinic.<your-domain>`
